class SingleFile
	...
	def build
		file = @title.tr('/', '')
	news_file = File.new("./economics/"+file+".html","w+")
		...
		<div class="col-lg-12 col-md-12">
		  ...
		  <div class="latest_newsarea">      
		    ...
		    <ul id="ticker01" class="news_sticker">
		        <li><a href="#"><img src="../img/economics_logo.jpg" alt="">الخبر اﻻول عن كذا</a></li> 
		        <li><a href="#"><img src="../img/economics_logo.jpg" alt="">الخبر اﻻول عن كذا</a></li> 
		        <li><a href="#"><img src="../img/economics_logo.jpg" alt="">الخبر اﻻول عن كذا</a></li> 
		        <li><a href="#"><img src="../img/economics_logo.jpg" alt="">الخبر اﻻول عن كذا</a></li> 
		        <li><a href="#"><img src="../img/economics_logo.jpg" alt="">الخبر اﻻول عن كذا</a></li> 
		        ...
		        <li>
		          <div class="media">
		            ...
		            <div class="media-body">
		              <a href="" class="catg_title"> أكد هانى زادة عضو مجلس إدارة نادى الزمالك، أن الزمالك هو الأقوى والأفضل والأكثر استعدادا لمباراة القمة أمام النادى الأهلى فى نهائى كأس مصر والمقرر لها السابع</a>                        
		            </div>
		          </div>
		        </li>
		        <li>
